...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(empty($_POST['email'])) {
        $errors[] = 'You forgot to enter your eamil address.';
    }
    else {
...
<form action="password.php" method="post">
    ...
    <p>Current Password: <input type="text" name="pass" size="10" maxlength="20" value="<?php if(isset($_POST['pass'])) echo $_POST['pass']; ?>"></p>
