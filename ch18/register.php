    ...
    if ($fn && $ln && $e && $p) {   // If everything's OK...
        ...
        if (mysqli_num_rows($r) == 0) { // Available.
            ...
            if (mysqli_affected_rows($dbc) == 1) {
                ...
                // Send the email:
                $body = "Thank you for registering at <whatever site>. To active your account, please click on this link:\n\n";
                $body .= BASE_URL . 'activate.php?x=' . urlencode($e) . "&y=$a";
                mail($trimmed['email'], 'Registration Confirmation', $body, 'From: admin@sitename.com');

                // Finish the page:
                echo '<h3>Thank you for registering! A confirmation email has been sent to your address. Please click on the link in that email in order to activate your account.</h3>' . '<p>For test, We display the email content:' . $body . '</p>';
