...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($uid) { // If everything's OK.
        ...
        if (mysqli_affected_rows($dbc) == 1) {  // If it ran OK.
            ...
            echo '<h3>Your password has been changed. You will receive the new, temporary password at the email address with which you registered. Once you have logged in with this password, you may change it by clicking on the "Change Password" link.</h3>' . '<p>For test, we display the email content here: ' . $body . '</p>';
            mysqli_close($dbc);
