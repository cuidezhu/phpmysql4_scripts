...
if (!empty($_SESSION['cart'])) {
    ...
    <tr>
        ...
        <td align="left" width="30%"><b>Price Name</b></td>
        <td align="right" width="10%"><b>Price</b></td>
        <td align="center" width="10%"><b>Qty</b></td>
        <td align="right" width="10%"><b>Total Priced</b></td>
    </tr>';
    ...
    mysqli_close($dbc); // Close the database connnection.
    ...
    </form><p align="center">Enter a quantity of 0 to reomve an item.
